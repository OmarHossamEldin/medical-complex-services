<template>
  <div id="q-app">
    <div>
      <h5 class="text-weight-bold">الأطباء</h5>
      <q-table
        :data="data"
        :columns="columns"
        row-key="name"
            ...
            <q-dialog v-model="show_add_dialog">
              <q-card style="font-family: 'JF Flat';">
                <q-card-section dir="rtl">
                  <div>
                    <p class="text-weight-bold">اضافة طبيب جديد</p>
            ...
            <div class="q-pa-sm q-gutter-sm">
              <q-dialog v-model="show_edit_dialog">
                <q-card style="font-family: 'JF Flat';">
                  <q-card-section dir="rtl">
                    <div>
                      <p class="text-weight-bold">تعديل الطبيب</p>
...
export default {
  ...
  methods: {
    ...
    deleteItem(item) {
      confirm("هل تريد حذف هذا الطبيب بالتأكيد؟") &&
        this.delete(item.id);
    },
    close() {

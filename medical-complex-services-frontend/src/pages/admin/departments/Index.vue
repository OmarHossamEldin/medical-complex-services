  ...
  <div>
    <div class="row">
      <div class="q-pa-md q-gutter-sm">
        <q-btn color="primary" icon-right="add" label="اضافة قسم" />
      </div>
    </div>
    <div class="q-pa-md">
    <q-table
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'calories', align: 'center', label: 'عدد مرات الطباعة', field: 'calories', sortable: true },
        { name: 'fat', label: 'التوقيت', field: 'fat', sortable: true },
        { name: 'carbs', label: 'م . مستخدم النظام', field: 'carbs' },
        { name: 'protein', label: 'م . الجهاز', field: 'protein' },
        { name: 'sodium', label: 'م . الفئة المحاسبية', field: 'sodium' },
        { name: 'calcium', label: 'م . الخدمة', field: 'calcium', sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10) },
        { name: 'iron', label: 'الحدث', field: row => row.id, format: val => `${'<q-btn color="primary" icon-right="add" label="اضافة قسم" />'}`, sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10) }
      ],
      data: [
        { id: 1, name: 'Frozen Yogurt', calories: 159, fat: 6.0, carbs: 24, protein: 4.0, sodium: 87, calcium: '14%' },
